...
const Conditions = ({ quoteID, close }) => {
  ...
  const handleAddConditionsClick = async (values, { setSubmitting }) => {
    try {
      const object = {
        ID: quoteID,
        TipoPago: values.paymentCondition != "Other" ? values.paymentCondition : values.otherPayment,
        TipoEnvio: values.deliveryCondition != "Other" ? values.deliveryCondition : values.otherDelivery,
