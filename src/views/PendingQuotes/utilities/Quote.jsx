      ...
      <div className="flex flex-col gap-2 p-4 max-h-screen overflow-y-scroll ">
        <div className="w-full flex flex-col gap-1">
          ...
          <div className="flex gap-5 mt-2 mb-5">
                    ...
                    <tbody>
                      {listItems.map((item, index) => (
                        <tr key={index} className="text-sm">
                          ...
                          <td className="w-16 border border-zinc-300 px-2">
                            <button
                              className="bg-sovetec-thirty h-10 px-2 rounded-sm text-white hover:bg-sovetec-primary"
                              onClick={() => setDiscount(item.ID)}
                            >
                              {item.Descuento != 0 ? (
                                <p>Cambiar</p>
                              ) : (
                            ...
                            {item.Descuento != 0 && (
                              <p className="mt-2">
                                $ {item.Descuento.toLocaleString("en-US")}
                              </p>
                            )}
                          </td>
                          {userData.Roles != "Supervisor" && (
            ...
            <div className="bg-white w-max  h-max p-5 rounded-md flex flex-col gap-3 sticky top-0">
              {userData.Roles != "Supervisor" && (
                <Button
                  variant="soft"
                  color="sky"
        ...
        {discount && (
          <Discount itemID={discount} close={() => setDiscount(null)} />
        )}
      </div>
    </>
  );
