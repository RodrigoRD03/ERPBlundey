...
const UpdateSupplier = () => {
  ...
  useEffect(() => {
    requests.getSupplier(supplierID).then((response) => {
  ...
  const handleEditSupplierClick = async (values, { setSubmitting }) => {
    try {
      const object = {
        ID: supplierData.ID,
        Nombre: values.name,
      ...
      const response = await requests.updateSupplier(object);
    ...
    <div className="flex flex-col gap-2 m-4">
      <div className="w-full flex flex-col gap-1">
        <p className="text-xs">
          ...
          <Link to="/Layout/Suppliers">Preveedores</Link> /{" "}
          <b>Editar Preveedor</b>
        </p>
        <p className="text-lg font-bold tracking-wide">Editar Proveedor</p>
      </div>
      ...
      <div className="bg-white w-max flex flex-col gap-2 p-5 rounded-md shadow-md">
        ...
        <Formik
          initialValues={{
            ...
            company: supplierData.Contacto,
            phone: supplierData.Telefono,
            email: supplierData.CorreoElectronico,
            address: supplierData.Estado,
            colony: supplierData.Municipio,
            municipality: supplierData.Colonia,
            postalCode: supplierData.CodigoPostal,
            rfc:  supplierData.RFC,
          }}
          validationSchema={validationSchema}
          onSubmit={handleEditSupplierClick}
          enableReinitialize
        >
          {({ isSubmitting }) => (
