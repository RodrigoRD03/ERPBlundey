...
const TaxDataComplete = () => {
  ...
  useEffect(() => {
    requests.getTaxData(supplierID).then((response) => {
      setTaxData(response);
    });
  }, []);
    ...
    <div className="flex flex-col gap-2 m-4">
      <div className="w-full flex flex-col gap-1">
        <p className="text-xs">
          ...
          <Link to="/Layout/TaxDataSuppliers">Datos Fiscales Proveedores</Link>{" "}
          / <b>Ver Datos Fiscales</b>
        </p>
        <p className="text-lg font-bold tracking-wide">
          Ver Datos Fiscales Proveedores
        </p>
      </div>
